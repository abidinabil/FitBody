  ...
  <div>
    ...
    <body>
        <div class="l-form">
            ...
            <div class="form">
                <img src="https://images.pexels.com/photos/6787498/pexels-photo-6787498.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" style="width:450px; height:500px ; border-radius:30px" alt="" class="form__img">
                ...
                <form action="" class="form__content">
                    ...
                    <button type="submit" class="form__button"  @click.prevent="performLogin"> Login</button>
                    ...
                    <div class="form__social">
                        ...
                        <a href="#" class="form__social-icon"><i class='bx bxl-github' ></i></a>
                    </div>
                </form>
            </div>
...
.shape1{
    top: -7rem;
    left: -3.5rem;
    background: linear-gradient(180deg, var(--first-color) 0%, rgba(172, 33, 33, 0) 100%);
}
.shape2{
    bottom: -6rem;
    right: -5.5rem;
...
.form__button:hover{
    box-shadow: 0px 15px 36px rgba(132, 135, 109, 0.15);
}
/*=== Form social===*/
.form__social{
    text-align: center;
